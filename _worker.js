...
const พร็อกซีไอพีs = ['sky.rethinkdns.com',`icook.hk`,`real.salarvand.org`.`VI6.0912.org`,'kelly-similiarbody.shop'];
 ...
 * @param {import("@cloudflare/workers-types").WebSocket} socket The WebSocket connec
