...
"
    ...
    echo "-------------------------------------------------------------------------"
sleep 0.5
echo "- MEMAKSIMALKAN FPS"
echo "- UNLOCK FPS 60-144 FPS"
echo "-------------------------------------------------------------------------"
sleep 0.5
...
##################################################################
(
cmd device_config put system display_refresh_rate 60
...
(
cmd device_config put system display_refresh_rate 90
...
(
cmd device_config put system display_refresh_rate 144
